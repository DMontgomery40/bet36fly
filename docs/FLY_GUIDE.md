...
For individual neurons, KC subtypes, APL, dopamine channels and MBON territories, use the [cell and circuit wiki](../wiki/index.md). Its [reassessment](../wiki/reassessment.md) records the unresolved learning mechanism and distinguishes repairs in another worktree from the code in this checkout.
