...
**2018 confirmation (one attempt, September 14):** better than chance; **plasticity does not contribute** (recovery plastic reliably worse than its frozen twin and than the encoder; equal to shuffled and to the no-recovery baseline). [Result](evidence/associative-learning-2026-09-13/sports-confirmation-2018.md). The block is spent.
