...
export default function TrainingView({ data, error, loading }: { data: Training | null; error: string; loading: boolean }) {
  ...
  return <section className="training-view"><div className="page-heading"><h1>What has it learned?</h1><p>Measured on held-out games. Compared with simpler controls.</p></div>
