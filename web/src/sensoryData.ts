...
export type Page = 'overview' | 'backtest' | 'methods';
...
export function route(hash: string): Page { return hash === '#backtest' || hash.startsWith('#backtest/') ? 'backtest' : hash === '#methods' ? 'methods' : 'overview'; }
