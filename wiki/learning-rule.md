...
updated: 2026-09-13
status: legacy-integrated-rules-qualification-failed
---
# Legacy reward circuit and learning-rule contract

This is the **legacy reward** circuit contract. The September 13 associative stage uses a different engine, compartments (PAM08/MBON05, PAM01/MBON01), cue code and reinforcer; see the integrated [associative-learning account](associative-learning.md) and [protocol](../docs/EXPERIMENT_ASSOCIATIVE.md). The [new sensory direction](../docs/PROJECT_DIRECTION.md) permits a separately specified input/output assay; the diagram below is not a natural fruit/sugar encoder or the new execution plan.
