...
a timestep-dependent inhibition recurrence. Neither can be imported silently
as a repair for endogenous untaught drift. No such local state is implemented.
