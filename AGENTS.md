...
- The fixed per-DAN DARELA transfer `bc6993b67befdb3a6c2d` is also rejected: all four home guards fail and every home trial becomes more depressive. Its independent audit matches all 567,424 final/electrical float32 endpoints exactly, with zero bounds or ambiguity. The mouse-WT1 every-spike/reset embedding remains outside production; do not tune its p/tau or other frozen choices against these outcomes. Cell-specific results and the continuation boundary are in `docs/evidence/reward-mechanism-repair-2026-09-12/darela-shadow-result-2026-09-13.md`.
